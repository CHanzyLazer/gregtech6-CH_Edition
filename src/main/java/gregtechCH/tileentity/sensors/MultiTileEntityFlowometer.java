...
public class MultiTileEntityFlowometer extends MultiTileEntitySensorTE {
	...
	public long getCurrentValue(DelegatorTileEntity<TileEntity> aDelegator) {
		if (aDelegator.mTileEntity instanceof ITileEntityFlowrate) return ((ITileEntityFlowrate)aDelegator.mTileEntity).getFlowrateValue(aDelegator.mSideOfTileEntity);
		return 0;
	}
	
	@Override
	public long getCurrentMax(DelegatorTileEntity<TileEntity> aDelegator) {
		if (aDelegator.mTileEntity instanceof ITileEntityFlowrate) return ((ITileEntityFlowrate)aDelegator.mTileEntity).getFlowrateMax(aDelegator.mSideOfTileEntity);
		return 0;
	}
