...
public class MTEC_MultiBlockCoagulator extends MTEC_MultiblockMachine {
    public MTEC_MultiBlockCoagulator(TileEntityBase10MultiBlockMachine aTE) {super(aTE);}
    ...
    public void toolTipsMultiblock(List<String> aList) {
        ...
        aList.add(LH.Chat.WHITE    + LH.get("gt.tooltip.multiblock.coagulator.1"));
        aList.add(LH.Chat.WHITE    + LH.get("gt.tooltip.multiblock.coagulator.2"));
        aList.add(LH.Chat.WHITE    + LH.get("gt.tooltip.multiblock.coagulator.3"));
    }
    ...
    @Override public String getTileEntityNameCompat() {return "gtch.multitileentity.multiblock.coagulator";}
}
