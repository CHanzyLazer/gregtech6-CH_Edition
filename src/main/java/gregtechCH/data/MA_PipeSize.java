...
public class MA_PipeSize extends HashMap<Size, MA_PipeSize.GeneralAttributes> {
    ...
    public MA_PipeSize() {
        put(Size.SMALL,        new MA_PipeSize.GeneralAttributes(0, 64, PX_P[ 6], V[0], 1));
        put(Size.MEDIUM,       new MA_PipeSize.GeneralAttributes(1, 32, PX_P[ 9], V[1], 4));
        put(Size.LARGE,        new MA_PipeSize.GeneralAttributes(2, 16, PX_P[12], V[2], 16));
        put(Size.HUGE,         new MA_PipeSize.GeneralAttributes(3, 8,  PX_P[16], V[3], 64));
    }
}
