 ...
 */
public class MultiTileEntityBath_CH extends TileEntityBase10MultiBlockMachine_CH {
	@Override
	...
	@Override public String getTileEntityName_CH() {return "gtch.multitileentity.multiblock.bath";}
}
