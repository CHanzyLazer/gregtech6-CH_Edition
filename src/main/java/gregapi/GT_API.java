...
//  }
	...
	public void onModPreInit2(FMLPreInitializationEvent aEvent) {
		...
		if (CODE_CLIENT) {
			...
			LanguageHandler_CH.sLangFile = new Configuration(tFile);
			LanguageHandler_CH.sUseFile = LanguageHandler_CH.sLangFile.get("EnableLangFile", "UseThisFileAsLanguageFile", F).getBoolean(F);
			LH_CH.init(); // 设置初始化事件
		} else {
