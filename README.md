...
下载地址 [Release](https://github.com/CHanzyLazer/gregtech6-CH_Edition/releases/tag/v6.15.01-CH-0.2.4)
，包含：
- mod 本体 [gregtech_1.7.10-6.15.01-CH-0.2.4.jar](https://github.com/CHanzyLazer/gregtech6-CH_Edition/releases/download/v6.15.01-CH-0.2.4/gregtech_1.7.10-6.15.01-CH-0.2.4.jar),
- 默认配置文件 [gregtech_1.7.10-6.15.01-CH-0.2.4-defaultConfigPack.zip](https://github.com/CHanzyLazer/gregtech6-CH_Edition/releases/download/v6.15.01-CH-0.2.4/gregtech_1.7.10-6.15.01-CH-0.2.4-defaultConfigPack.zip),
- 此版本专用的 OmniOcular 配置文件 [gregtech_1.7.10-6.15.01-CH-0.2.4-OmniOcular_CH.zip](https://github.com/CHanzyLazer/gregtech6-CH_Edition/releases/download/v6.15.01-CH-0.2.4/gregtech_1.7.10-6.15.01-CH-0.2.4-OmniOcular_CH.zip),
- 此版本额外增加文本的汉化文件 [gregtech_1.7.10-6.15.01-CH-0.2.4-langrage_CH.zip](https://github.com/CHanzyLazer/gregtech6-CH_Edition/releases/download/v6.15.01-CH-0.2.4/gregtech_1.7.10-6.15.01-CH-0.2.4-langrage_CH.zip)
