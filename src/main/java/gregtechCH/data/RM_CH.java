...
public class RM_CH extends RM {
    ...
    // TODO 重复项待移除
    , Assembler         = new RecipeMap             (RegType.GT6U, null, "gt6u.recipe.assembler"                      , "Circuit Assembler"               , null, 0, 1, RES_PATH_GUI+"machines/Assembler"         ,/*IN-OUT-MIN-ITEM=*/ 9, 1, 1,/*IN-OUT-MIN-FLUID=*/ 1, 0, 0,/*MIN*/ 1,/*AMP=*/ 1, ""                    ,   1, ""       , T, T, T, T, F, T, T)
