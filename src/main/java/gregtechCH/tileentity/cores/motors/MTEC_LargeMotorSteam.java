...
public class MTEC_LargeMotorSteam extends MTEC_LargeMotor {
    ...
    // init of core
    @Override protected void postInitTank() {super.postInitTank(); mTankWater.setCapacity(mD.mInRate*16).fixFluid(FL.DistW.fluid()).setSaveEmpty(F).setVoidExcess();} // core 不进行容量大小设定
