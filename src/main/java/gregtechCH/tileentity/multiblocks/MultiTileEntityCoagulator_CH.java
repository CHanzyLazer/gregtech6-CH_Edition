 ...
 */
public class MultiTileEntityCoagulator_CH extends TileEntityBase10MultiBlockMachine_CH {
	@Override
	...
	@Override public String getTileEntityName_CH() {return "gtch.multitileentity.multiblock.coagulator";}
}
