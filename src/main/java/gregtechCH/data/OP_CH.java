...
//    public static final OreDictPrefix wireLPGt[] = {wireLPGt01, wireLPGt02, wireLPGt04, wireLPGt08, wireLPGt12, wireLPGt16};
    ...
    /* GTCH stuffs */
    public static final OreDictPrefix
    depositRich                     = create("depositRich"                  , "Deposits"                    , ""                            , " Deposit").setCondition(ORES).add(UNIFICATABLE, ORE, MATERIAL_BASED, BLOCK_BASED, TOOLTIP_ENCHANTS              ).aspects(TC.TERRA      ,10).setTextureSetName("depositRich"),
    deposit                         = create("deposit"                      , "Deposits"                    , ""                            , " Deposit").setCondition(ORES).add(UNIFICATABLE, ORE, MATERIAL_BASED, BLOCK_BASED, TOOLTIP_ENCHANTS              ).aspects(TC.TERRA      ,10).setTextureSetName("deposit"),
    depositSmall                    = create("depositSmall"                 , "Deposits"                    , ""                            , " Deposit").setCondition(ORES).add(UNIFICATABLE, ORE, MATERIAL_BASED, BLOCK_BASED, TOOLTIP_ENCHANTS              ).aspects(TC.TERRA      ,10).setTextureSetName("depositSmall"),
    depositPoor                     = create("depositPoor"                  , "Deposits"                    , ""                            , " Deposit").setCondition(ORES).add(UNIFICATABLE, ORE, MATERIAL_BASED, BLOCK_BASED, TOOLTIP_ENCHANTS              ).aspects(TC.TERRA      ,10).setTextureSetName("depositPoor");
