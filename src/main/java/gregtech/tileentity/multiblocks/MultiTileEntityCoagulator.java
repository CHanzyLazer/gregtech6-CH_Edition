...
import gregtechCH.tileentity.cores.basicmachines.MTEC_MultiBlockCoagulator;
...
public class MultiTileEntityCoagulator extends TileEntityBase10MultiBlockMachine {
	@Override protected MTEC_MultiBlockMachine getNewCoreMultiBlock() {return new MTEC_MultiBlockCoagulator(this);}
