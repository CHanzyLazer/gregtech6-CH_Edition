...
public enum FL {
	...
	@SafeVarargs public static Fluid createLiquid(OreDictMaterial aMaterial, IIconContainer aTexture, Set<String>... aFluidList) {return create(aMaterial.mRegType, aMaterial.mNameInternal.toLowerCase(), aTexture, aMaterial.mNameLocal, aMaterial, aMaterial.mRGBaLiquid, STATE_LIQUID, 1000, aMaterial.mMeltingPoint <= 0 ? 1000 : aMaterial.mMeltingPoint < 300 ? Math.min(300, aMaterial.mBoilingPoint - 1) : aMaterial.mMeltingPoint, null, null, 0, aFluidList);}
	@SafeVarargs public static Fluid createLiquid(RegType aRegType, OreDictMaterial aMaterial, Set<String>... aFluidList) {return createLiquid(aRegType, aMaterial, aMaterial.mTextureSetsBlock.get(IconsGT.INDEX_BLOCK_MOLTEN), aFluidList);}
	@SafeVarargs public static Fluid createLiquid(RegType aRegType, OreDictMaterial aMaterial, IIconContainer aTexture, Set<String>... aFluidList) {return create(aRegType, aMaterial.mNameInternal.toLowerCase(), aTexture, aMaterial.mNameLocal, aMaterial, aMaterial.mRGBaLiquid, STATE_LIQUID, 1000, aMaterial.mMeltingPoint <= 0 ? 1000 : aMaterial.mMeltingPoint < 300 ? Math.min(300, aMaterial.mBoilingPoint - 1) : aMaterial.mMeltingPoint, null, null, 0, aFluidList);}
	...
	@SafeVarargs public static Fluid createMolten(OreDictMaterial aMaterial, long aAmount, IIconContainer aTexture, Set<String>... aFluidList) {return create(aMaterial.mRegType, "molten."+aMaterial.mNameInternal.toLowerCase(), aTexture, "Molten " + aMaterial.mNameLocal, aMaterial, aMaterial.mRGBaLiquid, STATE_LIQUID, aAmount, aMaterial.mMeltingPoint <= 0 ? 1000 : aMaterial.mMeltingPoint < 300 ? Math.min(300, aMaterial.mBoilingPoint - 1) : aMaterial.mMeltingPoint, null, null, 0, aFluidList).setLuminosity(10);}
	@SafeVarargs public static Fluid createMolten(RegType aRegType, OreDictMaterial aMaterial, Set<String>... aFluidList) {return createMolten(aRegType, aMaterial, L, aFluidList);}
	@SafeVarargs public static Fluid createMolten(RegType aRegType, OreDictMaterial aMaterial, long aAmount, Set<String>... aFluidList) {return createMolten(aRegType, aMaterial, aAmount, aMaterial.mTextureSetsBlock.get(IconsGT.INDEX_BLOCK_MOLTEN), aFluidList);}
	@SafeVarargs public static Fluid createMolten(RegType aRegType, OreDictMaterial aMaterial, long aAmount, IIconContainer aTexture, Set<String>... aFluidList) {return create(aRegType, "molten."+aMaterial.mNameInternal.toLowerCase(), aTexture, "Molten " + aMaterial.mNameLocal, aMaterial, aMaterial.mRGBaLiquid, STATE_LIQUID, aAmount, aMaterial.mMeltingPoint <= 0 ? 1000 : aMaterial.mMeltingPoint < 300 ? Math.min(300, aMaterial.mBoilingPoint - 1) : aMaterial.mMeltingPoint, null, null, 0, aFluidList).setLuminosity(10);}
	...
	@SafeVarargs public static Fluid createGas(OreDictMaterial aMaterial, IIconContainer aTexture, Set<String>... aFluidList) {return create(aMaterial.mRegType, aMaterial.mNameInternal.toLowerCase(), aTexture, aMaterial.mNameLocal, aMaterial, aMaterial.mRGBaGas, STATE_GASEOUS, 1000, aMaterial.mBoilingPoint <= 0 ? 3000 : aMaterial.mBoilingPoint < 300 ? Math.min(300, aMaterial.mPlasmaPoint - 1) : aMaterial.mBoilingPoint, null, null, 0, aFluidList);}
	@SafeVarargs public static Fluid createGas(RegType aRegType, OreDictMaterial aMaterial, Set<String>... aFluidList) {return createGas(aRegType, aMaterial, aMaterial.mTextureSetsBlock.get(IconsGT.INDEX_BLOCK_GAS), aFluidList);}
	@SafeVarargs public static Fluid createGas(RegType aRegType, OreDictMaterial aMaterial, IIconContainer aTexture, Set<String>... aFluidList) {return create(aRegType, aMaterial.mNameInternal.toLowerCase(), aTexture, aMaterial.mNameLocal, aMaterial, aMaterial.mRGBaGas, STATE_GASEOUS, 1000, aMaterial.mBoilingPoint <= 0 ? 3000 : aMaterial.mBoilingPoint < 300 ? Math.min(300, aMaterial.mPlasmaPoint - 1) : aMaterial.mBoilingPoint, null, null, 0, aFluidList);}
	...
	@SafeVarargs public static Fluid createVapour(OreDictMaterial aMaterial, IIconContainer aTexture, Set<String>... aFluidList) {return create(aMaterial.mRegType, "vapor."+aMaterial.mNameInternal.toLowerCase(), aTexture, "Vaporized " + aMaterial.mNameLocal, aMaterial, aMaterial.mRGBaGas, STATE_GASEOUS, 8*L, aMaterial.mBoilingPoint <= 0 ? 3000 : aMaterial.mBoilingPoint < 300 ? Math.min(300, aMaterial.mPlasmaPoint - 1) : aMaterial.mBoilingPoint, null, null, 0, aFluidList);}
	@SafeVarargs public static Fluid createVapour(RegType aRegType, OreDictMaterial aMaterial, Set<String>... aFluidList) {return createVapour(aRegType, aMaterial, aMaterial.mTextureSetsBlock.get(IconsGT.INDEX_BLOCK_GAS), aFluidList);}
	@SafeVarargs public static Fluid createVapour(RegType aRegType, OreDictMaterial aMaterial, IIconContainer aTexture, Set<String>... aFluidList) {return create(aRegType, "vapor."+aMaterial.mNameInternal.toLowerCase(), aTexture, "Vaporized " + aMaterial.mNameLocal, aMaterial, aMaterial.mRGBaGas, STATE_GASEOUS, 8*L, aMaterial.mBoilingPoint <= 0 ? 3000 : aMaterial.mBoilingPoint < 300 ? Math.min(300, aMaterial.mPlasmaPoint - 1) : aMaterial.mBoilingPoint, null, null, 0, aFluidList);}
	...
	@SafeVarargs public static Fluid createPlasma(OreDictMaterial aMaterial, IIconContainer aTexture, Set<String>... aFluidList) {return create(aMaterial.mRegType, "plasma."+aMaterial.mNameInternal.toLowerCase(), aTexture, aMaterial.mNameLocal + " Plasma", aMaterial, aMaterial.mRGBaPlasma, STATE_PLASMA, L*L, aMaterial.mPlasmaPoint <= 0 ? 10000 : Math.max(300, aMaterial.mPlasmaPoint), null, null, 0, aFluidList);}
	@SafeVarargs public static Fluid createPlasma(RegType aRegType, OreDictMaterial aMaterial, Set<String>... aFluidList) {return createPlasma(aRegType, aMaterial, aMaterial.mTextureSetsBlock.get(IconsGT.INDEX_BLOCK_PLASMA), aFluidList);}
	@SafeVarargs public static Fluid createPlasma(RegType aRegType, OreDictMaterial aMaterial, IIconContainer aTexture, Set<String>... aFluidList) {return create(aRegType, "plasma."+aMaterial.mNameInternal.toLowerCase(), aTexture, aMaterial.mNameLocal + " Plasma", aMaterial, aMaterial.mRGBaPlasma, STATE_PLASMA, L*L, aMaterial.mPlasmaPoint <= 0 ? 10000 : Math.max(300, aMaterial.mPlasmaPoint), null, null, 0, aFluidList);}
	...
	// 删除指定条目
	public static void removeCreate(String aName) {
		if (sReplacingCreateList.containsKey(aName)) {
	...
	@SafeVarargs public static void appendCreateBefore(String aBeforeName, String aName, String aLocalized, OreDictMaterial aMaterial, int aState, Set<String>... aFluidList) {appendCreateBefore(aBeforeName, aName, aLocalized, aMaterial, aState, 1000, 300, null, null, 0, aFluidList);}
	@SafeVarargs public static void appendCreateBefore(String aBeforeName, String aName, String aLocalized, OreDictMaterial aMaterial, int aState, long aAmountPerUnit, long aTemperatureK, Set<String>... aFluidList) {appendCreateBefore(aBeforeName, aName, aLocalized, aMaterial, aState, aAmountPerUnit, aTemperatureK, null, null, 0, aFluidList);}
	@SafeVarargs public static void appendCreateBefore(String aBeforeName, String aName, String aLocalized, OreDictMaterial aMaterial, int aState, long aAmountPerUnit, long aTemperatureK, ItemStack aFullContainer, ItemStack aEmptyContainer, int aFluidAmount, Set<String>... aFluidList) {appendCreateBefore(aBeforeName, aName, new Textures.BlockIcons.CustomIcon("fluids/" + aName.toLowerCase()), aLocalized, aMaterial, null, aState, aAmountPerUnit, aTemperatureK, aFullContainer, aEmptyContainer, aFluidAmount, aFluidList);}
	@SafeVarargs public static void appendCreateBefore(String aBeforeName, String aName, IIconContainer aTexture, String aLocalized, OreDictMaterial aMaterial, short[] aRGBa, int aState, long aAmountPerUnit, long aTemperatureK, ItemStack aFullContainer, ItemStack aEmptyContainer, int aFluidAmount, Set<String>... aFluidList) {appendCreateBefore(aBeforeName, RegType.GTCH, aName, aTexture, aLocalized, aMaterial, aRGBa, aState, aAmountPerUnit, aTemperatureK, aFullContainer, aEmptyContainer, aFluidAmount, aFluidList);}
	
	@SafeVarargs public static void appendCreateBefore(String aBeforeName, RegType aRegType, String aName, String aLocalized, OreDictMaterial aMaterial, int aState, Set<String>... aFluidList) {appendCreateBefore(aBeforeName, aRegType, aName, aLocalized, aMaterial, aState, 1000, 300, null, null, 0, aFluidList);}
	@SafeVarargs public static void appendCreateBefore(String aBeforeName, RegType aRegType, String aName, String aLocalized, OreDictMaterial aMaterial, int aState, long aAmountPerUnit, long aTemperatureK, Set<String>... aFluidList) {appendCreateBefore(aBeforeName, aRegType, aName, aLocalized, aMaterial, aState, aAmountPerUnit, aTemperatureK, null, null, 0, aFluidList);}
	@SafeVarargs public static void appendCreateBefore(String aBeforeName, RegType aRegType, String aName, String aLocalized, OreDictMaterial aMaterial, int aState, long aAmountPerUnit, long aTemperatureK, ItemStack aFullContainer, ItemStack aEmptyContainer, int aFluidAmount, Set<String>... aFluidList) {appendCreateBefore(aBeforeName, aRegType, aName, new Textures.BlockIcons.CustomIcon("fluids/" + aName.toLowerCase()), aLocalized, aMaterial, null, aState, aAmountPerUnit, aTemperatureK, aFullContainer, aEmptyContainer, aFluidAmount, aFluidList);}
	
	@SafeVarargs
	public static void appendCreateBefore(String aBeforeName, RegType aRegType, String aName, IIconContainer aTexture, String aLocalized, OreDictMaterial aMaterial, short[] aRGBa, int aState, long aAmountPerUnit, long aTemperatureK, ItemStack aFullContainer, ItemStack aEmptyContainer, int aFluidAmount, Set<String>... aFluidList) {
		CreateObject tCreateObject = new CreateObject(aRegType, aName, aTexture, aLocalized, aMaterial, aRGBa, aState, aAmountPerUnit, aTemperatureK, aFullContainer, aEmptyContainer, aFluidAmount, aFluidList);
	...
	// 在指定位置之后添加条目
	@SafeVarargs public static void appendCreateAfter(String aAfterName, String aName, String aLocalized, OreDictMaterial aMaterial, int aState, Set<String>... aFluidList) {appendCreateAfter(aAfterName, aName, aLocalized, aMaterial, aState, 1000, 300, null, null, 0, aFluidList);}
	@SafeVarargs public static void appendCreateAfter(String aAfterName, String aName, String aLocalized, OreDictMaterial aMaterial, int aState, long aAmountPerUnit, long aTemperatureK, Set<String>... aFluidList) {appendCreateAfter(aAfterName, aName, aLocalized, aMaterial, aState, aAmountPerUnit, aTemperatureK, null, null, 0, aFluidList);}
	@SafeVarargs public static void appendCreateAfter(String aAfterName, String aName, String aLocalized, OreDictMaterial aMaterial, int aState, long aAmountPerUnit, long aTemperatureK, ItemStack aFullContainer, ItemStack aEmptyContainer, int aFluidAmount, Set<String>... aFluidList) {appendCreateAfter(aAfterName, aName, new Textures.BlockIcons.CustomIcon("fluids/" + aName.toLowerCase()), aLocalized, aMaterial, null, aState, aAmountPerUnit, aTemperatureK, aFullContainer, aEmptyContainer, aFluidAmount, aFluidList);}
	@SafeVarargs public static void appendCreateAfter(String aAfterName, String aName, IIconContainer aTexture, String aLocalized, OreDictMaterial aMaterial, short[] aRGBa, int aState, long aAmountPerUnit, long aTemperatureK, ItemStack aFullContainer, ItemStack aEmptyContainer, int aFluidAmount, Set<String>... aFluidList) {appendCreateAfter(aAfterName, RegType.GTCH, aName, aTexture, aLocalized, aMaterial, aRGBa, aState, aAmountPerUnit, aTemperatureK, aFullContainer, aEmptyContainer, aFluidAmount, aFluidList);}
	
	@SafeVarargs public static void appendCreateAfter(String aAfterName, RegType aRegType, String aName, String aLocalized, OreDictMaterial aMaterial, int aState, Set<String>... aFluidList) {appendCreateAfter(aAfterName, aRegType, aName, aLocalized, aMaterial, aState, 1000, 300, null, null, 0, aFluidList);}
	@SafeVarargs public static void appendCreateAfter(String aAfterName, RegType aRegType, String aName, String aLocalized, OreDictMaterial aMaterial, int aState, long aAmountPerUnit, long aTemperatureK, Set<String>... aFluidList) {appendCreateAfter(aAfterName, aRegType, aName, aLocalized, aMaterial, aState, aAmountPerUnit, aTemperatureK, null, null, 0, aFluidList);}
	@SafeVarargs public static void appendCreateAfter(String aAfterName, RegType aRegType, String aName, String aLocalized, OreDictMaterial aMaterial, int aState, long aAmountPerUnit, long aTemperatureK, ItemStack aFullContainer, ItemStack aEmptyContainer, int aFluidAmount, Set<String>... aFluidList) {appendCreateAfter(aAfterName, aRegType, aName, new Textures.BlockIcons.CustomIcon("fluids/" + aName.toLowerCase()), aLocalized, aMaterial, null, aState, aAmountPerUnit, aTemperatureK, aFullContainer, aEmptyContainer, aFluidAmount, aFluidList);}
	
	@SafeVarargs public static void appendCreateAfterLiquid(String aAfterName, OreDictMaterial aMaterial, Set<String>... aFluidList) {appendCreateAfterLiquid(aAfterName, aMaterial, aMaterial.mTextureSetsBlock.get(IconsGT.INDEX_BLOCK_MOLTEN), aFluidList);}
	@SafeVarargs public static void appendCreateAfterLiquid(String aAfterName, OreDictMaterial aMaterial, IIconContainer aTexture, Set<String>... aFluidList) {appendCreateAfter(aAfterName, aMaterial.mRegType, aMaterial.mNameInternal.toLowerCase(), aTexture, aMaterial.mNameLocal, aMaterial, aMaterial.mRGBaLiquid, STATE_LIQUID, 1000, aMaterial.mMeltingPoint <= 0 ? 1000 : aMaterial.mMeltingPoint < 300 ? Math.min(300, aMaterial.mBoilingPoint - 1) : aMaterial.mMeltingPoint, null, null, 0, aFluidList);}
	
	@SafeVarargs
	public static void appendCreateAfter(String aAfterName, RegType aRegType, String aName, IIconContainer aTexture, String aLocalized, OreDictMaterial aMaterial, short[] aRGBa, int aState, long aAmountPerUnit, long aTemperatureK, ItemStack aFullContainer, ItemStack aEmptyContainer, int aFluidAmount, Set<String>... aFluidList) {
		CreateObject tCreateObject = new CreateObject(aRegType, aName, aTexture, aLocalized, aMaterial, aRGBa, aState, aAmountPerUnit, aTemperatureK, aFullContainer, aEmptyContainer, aFluidAmount, aFluidList);
	...
	private static class CreateObject {
		...
		public Fluid createSelf() {
			...
			if (aRegType == RegType.GREG) {
				LH.add(rFluid.getUnlocalizedName(), aLocalized);
					} else {
				LH_CH.add(aRegType, rFluid.getUnlocalizedName(), aLocalized);
				LH_CH.add(aRegType, rFluid.getUnlocalizedName()+".name", aLocalized);
			}
