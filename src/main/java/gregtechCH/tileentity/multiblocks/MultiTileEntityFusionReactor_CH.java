 ...
 */
public class MultiTileEntityFusionReactor_CH extends TileEntityBase10MultiBlockMachine_CH {
	@Override
	...
	@Override public String getTileEntityName_CH() {return "gtch.multitileentity.multiblock.fusionreactor";}
}
