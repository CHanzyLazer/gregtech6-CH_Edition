 ...
 * stuff from GT6U
 */
public class MTEC_MultiBlockMatterReplicator extends MTEC_MultiBlockMachine {
    public MTEC_MultiBlockMatterReplicator(TileEntityBase10MultiBlockMachine aTE) {super(aTE);}
    ...
    public boolean checkStructure2() {
        ...
        if (mTE.getWorldObj().blockExists(tX, tY, tZ) && mTE.getWorldObj().blockExists(tX+4, tY, tZ) && mTE.getWorldObj().blockExists(tX, tY, tZ+4) && mTE.getWorldObj().blockExists(tX+4, tY, tZ+4)) {
            ...
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(mTE, tX+1, tY+2, tZ+1, 18044, mTE.getMultiTileEntityRegistryID(), 0, MultiTileEntityMultiBlockPart.NOTHING)) tSuccess = F;
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(mTE, tX+2, tY+2, tZ+1, 18044, mTE.getMultiTileEntityRegistryID(), 0, MultiTileEntityMultiBlockPart.NOTHING)) tSuccess = F;
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(mTE, tX+3, tY+2, tZ+1, 18044, mTE.getMultiTileEntityRegistryID(), 0, MultiTileEntityMultiBlockPart.NOTHING)) tSuccess = F;
            ...
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(mTE, tX+1, tY+2, tZ+2, 18044, mTE.getMultiTileEntityRegistryID(), 0, MultiTileEntityMultiBlockPart.NOTHING)) tSuccess = F;
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(mTE, tX+2, tY+2, tZ+2, 18044, mTE.getMultiTileEntityRegistryID(), 0, MultiTileEntityMultiBlockPart.NOTHING)) tSuccess = F;
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(mTE, tX+3, tY+2, tZ+2, 18044, mTE.getMultiTileEntityRegistryID(), 0, MultiTileEntityMultiBlockPart.NOTHING)) tSuccess = F;
            ...
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(mTE, tX+1, tY+2, tZ+3, 18044, mTE.getMultiTileEntityRegistryID(), 0, MultiTileEntityMultiBlockPart.NOTHING)) tSuccess = F;
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(mTE, tX+2, tY+2, tZ+3, 18044, mTE.getMultiTileEntityRegistryID(), 0, MultiTileEntityMultiBlockPart.NOTHING)) tSuccess = F;
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(mTE, tX+3, tY+2, tZ+3, 18044, mTE.getMultiTileEntityRegistryID(), 0, MultiTileEntityMultiBlockPart.NOTHING)) tSuccess = F;
    ...
    static {
        LH_CH.add(RegType.GT6U, "gt6u.tooltip.multiblock.matterreplicator.1", "5x5x3 5x5x3 'Basin' of 56 Dense Lead Walls");
        LH_CH.add(RegType.GT6U, "gt6u.tooltip.multiblock.matterreplicator.2", "3x3x2 Filling with 26 Osmium Coils inside the 5x5x5");
        LH_CH.add(RegType.GT6U, "gt6u.tooltip.multiblock.matterreplicator.3", "Main Block centered on Side-Bottom and facing outwards");
        LH_CH.add(RegType.GT6U, "gt6u.tooltip.multiblock.matterreplicator.4", "Stuff can go in and out on any of the Dense Lead Walls");
    }
    
    @Override
    public void toolTipsMultiblock(List<String> aList) {
        aList.add(LH.Chat.CYAN  + LH.get(LH.STRUCTURE) + ":");
        aList.add(LH.Chat.WHITE + LH_CH.get("gt6u.tooltip.multiblock.matterreplicator.1"));
        aList.add(LH.Chat.WHITE + LH_CH.get("gt6u.tooltip.multiblock.matterreplicator.2"));
        aList.add(LH.Chat.WHITE + LH_CH.get("gt6u.tooltip.multiblock.matterreplicator.3"));
        aList.add(LH.Chat.WHITE + LH_CH.get("gt6u.tooltip.multiblock.matterreplicator.4"));
    }
