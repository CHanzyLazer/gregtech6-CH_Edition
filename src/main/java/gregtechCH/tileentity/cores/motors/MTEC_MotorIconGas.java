...
public class MTEC_MotorIconGas extends MTEC_MotorIconBase {
    ...
    @Override protected IIconContainer getOverlaySideUpIcon      () {return mCore.mD.mActive ? (mCore.mD.mCounterClockwise ? SIDE_RIGHT : SIDE_LEFT) : (mCore.mD.mPreheat||mCore.mD.mCooldown ? (mCore.mD.mCounterClockwise ? SIDE_P_RIGHT : SIDE_P_LEFT) : SIDE_HORIZONTAL);}
    @Override protected IIconContainer getOverlaySideDownIcon    () {return mCore.mD.mActive ? (mCore.mD.mCounterClockwise ? SIDE_LEFT : SIDE_RIGHT) : (mCore.mD.mPreheat||mCore.mD.mCooldown ? (mCore.mD.mCounterClockwise ? SIDE_P_LEFT : SIDE_P_RIGHT) : SIDE_HORIZONTAL);}
    @Override protected IIconContainer getOverlaySideLeftIcon    () {return mCore.mD.mActive ? (mCore.mD.mCounterClockwise ? SIDE_UP : SIDE_DOWN) : (mCore.mD.mPreheat||mCore.mD.mCooldown ? (mCore.mD.mCounterClockwise ? SIDE_P_UP : SIDE_P_DOWN) : SIDE_VERTICAL);}
    @Override protected IIconContainer getOverlaySideRightIcon   () {return mCore.mD.mActive ? (mCore.mD.mCounterClockwise ? SIDE_DOWN : SIDE_UP) : (mCore.mD.mPreheat||mCore.mD.mCooldown ? (mCore.mD.mCounterClockwise ? SIDE_P_DOWN : SIDE_P_UP) : SIDE_VERTICAL);}
}
